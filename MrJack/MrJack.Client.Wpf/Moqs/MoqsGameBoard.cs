...
namespace MrJack.Client.Wpf.Moqs
{
    public class MoqsGameBoard : IGameBoard
    {
        ...
        public MoqsGameBoard()
        {
            ...
            Board[1, 1] = CreateCard(Killers.InspLestrade, true, true, true, false);
            Board[1, 2] = CreateCard(Killers.JeremyBert, true, false, true, true);
            Board[1, 3] = CreateCard(Killers.JohnPizer, true, true, true, false);
            Board[1, 4] = CreateJeton(Detectives.Watson);
            Board[2, 0] = CreateJeton(Detectives.None); // Line 2
            Board[2, 1] = CreateCard(Killers.JohnSmith, true, true, true, true);
            Board[2, 2] = CreateCard(Killers.JosephLane, true, false, true, true);
            ...
            Board[3, 1] = CreateCard(Killers.MissStealthy, true, false, true, true);
            Board[3, 2] = CreateCard(Killers.SgtGoodley, false, true, true, true);
            Board[3, 3] = CreateCard(Killers.WilliamGull, true, true, true, true);
